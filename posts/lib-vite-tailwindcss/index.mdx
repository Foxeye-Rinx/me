...
For Storybook, you can use the `vite` bundler instead of `webpack`.
For more information, see my previous post [Using Vite for Bundler in Storybook](/posts/storybook-vite/).
